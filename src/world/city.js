...
// Правка 27.08.2026 по второму листу референса: высоту убавили ЗРЯ. На кадрах здания
// в двадцать-сорок ростов человека, и человек на двух кадрах стоит для масштаба. Пусто
// было не от высоты, а от ширины: улица там — узкий каньон между огромными массивами.
// Ширина участка 284 при стенах в 20 этажей и даёт каньон.
// Улица 125 единиц шириной при доме в 500 — это щель, а не каньон: на кадрах
// референса отношение ближе к одному к двум. Высоты умерены.
const AREA_HEIGHT = {
  yard: [5, 8], court: [6, 9], street: [10, 16], gallery: [8, 12],
  colonnade: [9, 14], tunnel: [6, 9], tower: [16, 26], hall: [12, 16],
};
