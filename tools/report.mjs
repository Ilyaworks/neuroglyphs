...
// Вывод показывается человеку, вместе со скриншотом, путь к которому напечатан внизу.
//
...
say('=== ОТЧЁТ ЧЕЛОВЕКУ от рабочей сессии neuroglyphs ===');
say('');
...
say('=== КОНЕЦ СООБЩЕНИЯ ===');
say('');
say('Человеку: посмотри скриншоты из списка выше. Если задаче назначена приёмка');
say('глазами, модель сама покажет список пунктов и подождёт твоего «принято».');
say('Не уверен, чей ход — выполни: node tools/what-now.mjs');
