...
say('# Сверка состояния neuroglyphs');
say('');
...
say('');
say('Отправь этот текст и последний скриншот Клоду. Он сверит с .planning/REFERENCE.md');
say('и скажет: идём дальше, добираем картинку или откатываем задачу.');
